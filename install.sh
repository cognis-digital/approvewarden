#!/usr/bin/env sh
# Universal installer for approvewarden. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/approvewarden.git"
echo "Installing approvewarden ..."
...
echo "Done. Run: approvewarden --help"
